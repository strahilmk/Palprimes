...
CREATE TABLE [dbo].[Number] (
    ...
    CONSTRAINT [UK_Number_Name] UNIQUE NONCLUSTERED ([Value] ASC)
);
...
GO
PRINT N'Creating [dbo].[Number_UniqueId]...';


GO
ALTER TABLE [dbo].[Number]
    ADD CONSTRAINT [Number_UniqueId] DEFAULT (newid()) FOR [UniqueId];
...
GO
PRINT N'Creating [dbo].[Number_CreateDate]...';


GO
ALTER TABLE [dbo].[Number]
    ADD CONSTRAINT [Number_CreateDate] DEFAULT (getdate()) FOR [CreateDate];


GO
PRINT N'Creating [dbo].[Number_LastUpdate]...';


GO
ALTER TABLE [dbo].[Number]
    ADD CONSTRAINT [Number_LastUpdate] DEFAULT (getdate()) FOR [LastUpdate];
...
INSERT INTO [dbo].Number([Value], IsPalindrom, IsPrime)
VALUES ('1',0,0);
